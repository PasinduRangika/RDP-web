    ...
    <div class="container">
        <div class="row justify-content-center">
            ...
            <div class="col-12 d-flex justify-content-center">
                <div class="section-blog-insights-list__latest-blog-card">
                    ...
                    <div class="section-blog-insights-list__blogcard-first-row">
                        ...
                        <a href="<?php the_permalink($latest_post->ID); ?>"
                    ...
                    <div class="section-blog-insights-list__blogcard-second-row">
                        <h3 class="section-blog-insights-list__latest-blog-title"><?php the_title(); ?></h3>
            ...
            $all_posts_query = new WP_Query([
                'post_type' => 'post',
                'post_status' => 'publish',
                'posts_per_page' => 6, // Adjust this to your preferred number of posts per page
                'paged' => $paged, // Current page number
                'post__not_in' => [$latest_post_id], // Exclude latest post
            ]);
